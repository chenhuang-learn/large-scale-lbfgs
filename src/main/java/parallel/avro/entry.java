...
public class entry extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static parallel.avro.entry.Builder newBuilder() {
    return new parallel.avro.entry.Builder();
  }
  
  /** Creates a new entry RecordBuilder by copying an existing Builder */
  public static parallel.avro.entry.Builder newBuilder(parallel.avro.entry.Builder other) {
    return new parallel.avro.entry.Builder(other);
  }
  
  /** Creates a new entry RecordBuilder by copying an existing entry instance */
  public static parallel.avro.entry.Builder newBuilder(parallel.avro.entry other) {
    return new parallel.avro.entry.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<entry>
    ...
    private Builder() {
      super(parallel.avro.entry.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(parallel.avro.entry.Builder other) {
      super(other);
    ...
    private Builder(parallel.avro.entry other) {
            super(parallel.avro.entry.SCHEMA$);
      if (isValidValue(fields()[0], other.index)) {
        this.index = data().deepCopy(fields()[0].schema(), other.index);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'index' field */
    public parallel.avro.entry.Builder setIndex(int value) {
    ...
    public parallel.avro.entry.Builder clearIndex() {
    ...
    /** Sets the value of the 'value' field */
    public parallel.avro.entry.Builder setValue(float value) {
    ...
    public parallel.avro.entry.Builder clearValue() {
