...
public class lbfgsdata extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public java.util.List<parallel.avro.entry> features;
   ...
   */
  public lbfgsdata(java.lang.Integer response, java.util.List<parallel.avro.entry> features, java.lang.Float weight, java.lang.Float offset) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: features = (java.util.List<parallel.avro.entry>)value$; break;
   ...
   */
  public java.util.List<parallel.avro.entry> getFeatures() {
    return features;
  }
   ...
   * @param value the value to set.
   */
  public void setFeatures(java.util.List<parallel.avro.entry> value) {
    this.features = value;
  }
  ...
  public static parallel.avro.lbfgsdata.Builder newBuilder() {
    return new parallel.avro.lbfgsdata.Builder();
  }
  
  /** Creates a new lbfgsdata RecordBuilder by copying an existing Builder */
  public static parallel.avro.lbfgsdata.Builder newBuilder(parallel.avro.lbfgsdata.Builder other) {
    return new parallel.avro.lbfgsdata.Builder(other);
  }
  
  /** Creates a new lbfgsdata RecordBuilder by copying an existing lbfgsdata instance */
  public static parallel.avro.lbfgsdata.Builder newBuilder(parallel.avro.lbfgsdata other) {
    return new parallel.avro.lbfgsdata.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<lbfgsdata>
    ...
    private java.util.List<parallel.avro.entry> features;
    private float weight;
    private float offset;

    /** Creates a new Builder */
    private Builder() {
      super(parallel.avro.lbfgsdata.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(parallel.avro.lbfgsdata.Builder other) {
      super(other);
    ...
    private Builder(parallel.avro.lbfgsdata other) {
            super(parallel.avro.lbfgsdata.SCHEMA$);
      if (isValidValue(fields()[0], other.response)) {
        this.response = data().deepCopy(fields()[0].schema(), other.response);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'response' field */
    public parallel.avro.lbfgsdata.Builder setResponse(int value) {
    ...
    public parallel.avro.lbfgsdata.Builder clearResponse() {
    ...
    /** Sets the value of the 'features' field */
    public parallel.avro.lbfgsdata.Builder setFeatures(java.util.List<parallel.avro.entry> value) {
    ...
    public parallel.avro.lbfgsdata.Builder clearFeatures() {
      features = null;
    ...
    /** Sets the value of the 'weight' field */
    public parallel.avro.lbfgsdata.Builder setWeight(float value) {
    ...
    public parallel.avro.lbfgsdata.Builder clearWeight() {
    ...
    /** Sets the value of the 'offset' field */
    public parallel.avro.lbfgsdata.Builder setOffset(float value) {
    ...
    public parallel.avro.lbfgsdata.Builder clearOffset() {
    ...
    public lbfgsdata build() {
      try {
        ...
        record.features = fieldSetFlags()[1] ? this.features : (java.util.List<parallel.avro.entry>) defaultValue(fields()[1]);
